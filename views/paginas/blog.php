...
<!----START BLOG SECTION----->
<div class="blog-section blog-list pt-90 pb-70">
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-8 col-lg-8">
				...
				<div class="pagination pt-30">
					<a href="blog-list.html" class="active">1</a>
					<a href="blog-list-two.html">2</a>
					<a href="blog-list-two.html"><i class="fas fa-angle-double-right"></i></a>
				</div>
			</div>
			<div class="col-sm-12 col-md-4 col-lg-4">
				...
				<div class="widget-items mb-40">
					<div class="section-head mb-40">
						<h4>About Me</h4>
						<div class="animated-bar-2"><span></span></div>
					</div>
				...
				<div class="widget-items mb-40">
					...
					<div class="widget-post">
						...
						<div class="widget-single-post">
							...
							<div class="post-content">
								<h4>
									<a href="#">Convincing reasons you need to learn </a>
								</h4>
								<div class="post-meta">
									<p>December 4, 2018</p>
								</div>
